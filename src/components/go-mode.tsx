 ...
 * compass alone. Destination-agnostic: venues and history sites both
 * ride it — the route API takes any coordinates.
 */
export function GoMode({ name, target }: { name: string; target: Coordinates | undefined }) {
