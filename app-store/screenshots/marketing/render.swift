...
let panels = [
  Panel(file: "01-history-all-around-you.png", sourceFile: "01-nearby-greenwich.png",
        headline: "History is hiding\nall around you",
        subhead: "Discover remarkable stories within walking distance.",
  ...
  Panel(file: "02-walk-into-the-story.png", sourceFile: "02-walking-route.png",
        ...
        subhead: "Follow a real walking route to every discovery.",
  ...
  Panel(file: "03-places-come-alive.png", sourceFile: "03-history-greenwich.png",
        headline: "Go as deep as\ncuriosity takes you",
        subhead: "Start with a telling, then explore the full history and sources.",
  ...
  Panel(file: "04-centuries-at-a-glance.png", sourceFile: "04-historical-timeline.png",
        headline: "Centuries,\nat a glance",
        subhead: "Explore defining moments through visual timelines and stories.",
  ...
  Panel(file: "05-never-walk-past.png", sourceFile: "05-landmark-story.png",
        headline: "Never just\nwalk past again",
        subhead: "Ships, statues, plaques and buildings—each has a story to tell.",
